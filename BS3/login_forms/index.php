      ...
      <div id="small-dialog1" class="mfp-hide">
         <div class="contact-form1">
            <div class="contact-w3-agileits">
               <h3>Register Form</h3>
               <form action="../back/insert_normal_user.php" method="post">
                  <div class="form-sub-w3ls">
                     <input placeholder="User Name" name="user_name" type="text" required="">
				  ...
				  <div class="form-sub-w3ls">
                     <input placeholder="Enter Security Question"  name="question" type="text" required="">
                     <div class="icon-agile">
                        <i class="fa fa-unlock-alt" aria-hidden="true"></i>
                     </div>
                  </div>
				  <div class="form-sub-w3ls">
                     <input placeholder="Enter Security answer"  name="answer" type="text" required="">
                     <div class="icon-agile">
                        <i class="fa fa-unlock-alt" aria-hidden="true"></i>
                     </div>
                  </div>
