...
var countDownDate = new Date().getTime()+60*5000;
...
?>
			...
			<label class="question-label"><?php
				echo $i; ?></label>	
                <label > <textarea style="border: none; width:80%; background-color: transparent;" id="<?php echo $i; ?>"  style="width:50%"><?php echo $row['question']; ?> </textarea>  <div class="button" onclick="speak('<?php echo $i; ?>');">Speak</div> </label>
                <br/>	
			<input type="radio" name="ans<?php
				echo $i; ?>" value="a"/>
							<label ><?php
				echo $row['optiona']; ?></label><br />
                         <input type="radio" name="ans<?php
				echo $i; ?>" value="b"/>
							<label ><?php
				echo $row['optionb']; ?></label><br />
                         <input type="radio" name="ans<?php
				echo $i; ?>" value="c"/>
							<label ><?php
				echo $row['optionc']; ?></label><br />
                         <input type="radio" name="ans<?php
				echo $i; ?>" value="d"/>
							<label ><?php
				echo $row['optiond']; ?></label><br />	
